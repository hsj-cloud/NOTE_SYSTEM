...
void search_delect_file_tag ( struct treenode*tree ); //根节点
void tag_s ( struct treenode*tree ); //当前目录根节点
void tag_sa ( struct treenode*tree ); //当前目录根节点
...
void search_file_tag ( struct treenode*tree ) //根节点
...
void search_add_file_tag ( struct treenode*tree ) //根节点
{
